# Using fmisc Custom Linting Rules

## Introduction

The `fmisc` package provides custom linting rules for the **flir**
package. This vignette demonstrates how to use these custom rules in
your R projects.
